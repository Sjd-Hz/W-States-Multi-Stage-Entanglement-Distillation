 ...
 %  via CNOT teleportation with 
    ...
    %% CNOT Operations
    % CNOT: qubit 2 controls B2 (qubit 5)
    CNOT_2to5 = CNOTn(5,2,5);
    
    % CNOT: B1 (qubit 4) controls qubit 1
    CNOT_4to1 = CNOTn(5,4,1);
    
    % Apply both CNOTs
    rho_after_CNOTs = CNOT_4to1 * CNOT_2to5 * rho_total * CNOT_2to5' * CNOT_4to1';
